 ...
 * All rights reserved.
 *
 * $Id: mbportserial_m168.c,v 1.8 2010-06-22 18:53:33 embedded-so.embedded-solutions.1 Exp $
 */
...
#define RS_485_ENABLED          ( 0 )

#if RS_485_ENABLED == 1
#define RS_485_DE_PIN			( PB7 )
#define RS_485_PORT             ( PORTB )
#define RS_485_DDR              ( DDRB )
