...
/* ----------------------- Defines ------------------------------------------*/
#define CRC16_USETABLE				( 1 )
/* ----------------------- Static variables ---------------------------------*/

#if CRC16_USETABLE == 1
static const UBYTE aucCRCHi[] = {
...
#else
        usCRCTableValue = usUtlCRC16GetTab( ubIndex );
        ubCRCLo = ubCRCHi ^ ( UBYTE ) ( usCRCTableValue & 0xFF );
        ubCRCHi = ( UBYTE ) ( usCRCTableValue >> 8U );
#endif
